...
public class ACT2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Numero y Potencia");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int porcentaje;
        porcentaje = Integer.parseInt(txt1.getText());
        int potencia;
        potencia = Integer.parseInt(txt1.getText());
        int PotenciaTotal;
        PotenciaTotal = (int)Math.pow(porcentaje,potencia);
        lbl1.setText("Tu potencia es: "+PotenciaTotal);
